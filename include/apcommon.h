...
RECOMP_IMPORT(".", u32 rando_send_message());
RECOMP_IMPORT(".", void rando_get_location_item_name(u32 location_id));
RECOMP_IMPORT(".", void rando_get_location_item_player_name(u32 location_id));
